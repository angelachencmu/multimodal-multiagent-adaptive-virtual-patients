        ...
        <div className="flex-none flex flex-col border p-5 rounded-xl shadow bg-white w-full text-center">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className="mt-2 px-4 py-2 rounded-full bg-teal tracking-wide border-4 border-solid duration-300 border-teal text-white w-1/2 hover:tracking-wider hover:bg-white hover:text-teal"
                >
                    <h2 className="uppercase font-bold">Theo</h2>
                </button>
                <button
                    onClick={() => changeCharacter("Sam")}
                    className="mt-2 px-4 py-2 rounded-full bg-blue tracking-wide border-4 border-solid duration-300 border-blue text-white w-1/2 hover:tracking-wider hover:bg-white hover:text-blue"
                >
                    <h2 className="uppercase font-bold">Sam</h2>
                </button>
            </div>
        </div>
        <div className="flex-none flex flex-col border p-4 rounded-xl shadow bg-white w-full text-blue">
            <h1 className="text-blue uppercase font-bold tracking-wide mb-5 text-xl"> Character Information </h1>
